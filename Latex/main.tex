...
Eine weitere Variante des FCM-Algorithmus, der Selective Scale Space based FCM \cite{scalespacefcm}, wurde entworfen, um den Clusteringprozess raumbezogener Daten zu verbessern. \\
...
\includepdf[pages=-,scale=0.85]{jupyter.pdf}
