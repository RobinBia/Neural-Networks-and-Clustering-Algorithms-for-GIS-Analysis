...
\textbf{Genaueres zu dem Tool, den Parametern und der Verwendung unter Umständen hier?}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{svm1.jpg}
\includegraphics[scale=0.45]{svm2.jpg}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{svm3.jpg}
\end{figure}
...
%Siehe Tab in Browser zu arcgis Werkzeugen Antwendungsgebiete 
