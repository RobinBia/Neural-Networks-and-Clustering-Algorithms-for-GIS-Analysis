...
\If{$E\in C_j, \forall j=1\dots m \& j\neq i$}
...
Eine weitere Klasse von Clustervaliditätsindizes basiert auf der gleichzeitigen Optimierung von Kompaktheit und Separation:
\begin{itemize}
...
\subsubsection{Otsu-Binarisierung}
...
%Voraussichtlich diskretisierung von Rasterbildern, Optics, FCM, Delaunay, 
