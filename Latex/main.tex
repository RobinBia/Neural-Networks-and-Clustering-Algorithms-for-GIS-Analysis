...
\begin{algorithmic}[1]
\Require{$X$ ist ein $d$-dimensionaler Datensatz mit $n$ Datenpunkten, $2 \leq
c \leq n$ ist die Clusteranzahl, $m > 1$ ist  die Vagheit und $ \epsilon > 0$ ist die Terminierungsgenauigkeit}
